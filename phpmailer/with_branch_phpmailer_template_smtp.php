...
<head>
    ...
    <title>ATIMAN | Online Resource Room Assessment</title>
...
try {
    ...
    $message .= "<br />Are you experiencing any difficulty in breathing? " . $_POST['question_3'];
    if (isset($_POST['question_4']) && $_POST['question_4'] != "")
        {
        $message .= "<br />Please tick any one of the following symptoms that can be applies to you:<br />";
